...
// tüm maksimum sayıları minimum sayı ile değiştir
        ...
        Collections.sort(arrList, Collections.reverseOrder()); // reverseorder methodu ters siralar  decending
        // sort () siralar
        System.out.println("ters siraladiktan sonra arrlist = " + arrList);

        Collections.shuffle(arrList); // rastgele karistirir

        System.out.println("shufle yaptiktn sonra" + arrList);

        Collections.rotate(arrList, 3);
        System.out.println("yer degistirildikten sonra" + arrList);
        ...
        System.out.println("Replaceall yapildiktan sonra " + arrList);
