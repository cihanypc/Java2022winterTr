 ...
 */
        ...
        // ArrayList listRakam tanimlanip, initialize ediliyor. Arrays.asList() ileArrayList<Integer> listRakam = new ArrayList<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9));
        ...
        System.out.println("listIsimler'de ipek elamanı ...");
